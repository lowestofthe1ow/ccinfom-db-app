...
python3 csv_to_sql_insert.py "base_records.sql" "base/genres.csv" "genre"
...
python3 csv_to_sql_insert.py "base_records.sql" "base/performance_slot.csv" "performance_slot"